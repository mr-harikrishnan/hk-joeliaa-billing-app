  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // Securely flag this browser instance as an active admin session
        localStorage.setItem('joeliaa_admin_active', 'true');
        setSuccess(true);
        setTimeout(() => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-[#F8F9FA] overflow-hidden selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <div className="hidden lg:flex w-[40%] bg-[#0B0E14] flex-col justify-between p-16 relative overflow-hidden">
        ...
        >
          <div className="w-12 h-12 rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white/5 p-0.5">
            <Image src="/JOELIAA.png" alt="Joeliaa" width={48} height={48} className="object-cover rounded-xl" />
          </div>
          <div>
            <span className="text-white font-black text-xl tracking-tighter block leading-none">JOELIAA</span>
            <span className="text-emerald-500 text-[9px] font-bold uppercase tracking-[0.2em] mt-1 block">Billing Suite</span>
          </div>
        </motion.div>
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <h1 className="text-white text-5xl font-black leading-[1.1] tracking-tighter">
              The smart way to<br />
              <span className="text-emerald-400 italic">scale</span> your<br />
              treats business.
            </h1>

            <p className="text-white/40 text-base leading-relaxed max-w-sm font-medium">
              Seamlessly manage billing, track every order, and watch your homemade business grow.
            </p>
          </motion.div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[#F8F9FA] relative">
        <div className="absolute top-0 right-0 p-8 hidden sm:block">
           <div className="text-[10px] text-slate-300 font-bold uppercase tracking-widest">System Status: <span className="text-emerald-500">Online</span></div>
        </div>
        ...
        >
          ...
          <div className="lg:hidden flex flex-col items-center gap-4 mb-12">
            <div className="w-16 h-16 rounded-3xl overflow-hidden shadow-xl border-4 border-white bg-white">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs font-bold text-slate-400 uppercase tracking-[0.4em] ml-1">Secure Admin Portal</p>
            </div>
          </div>

          {/* Heading */}
          <div className="mb-10 lg:text-left text-center">
            <h2 className="text-slate-900 text-4xl font-black tracking-tighter mb-2 italic">Welcome back</h2>
            <p className="text-slate-400 text-sm font-medium">Access your administrative dashboard with your unique credentials.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] ml-1">Admin Identity</label>
            ...
            <div className="space-y-2">
              <label className="text-slate-500 text-[10px] font-black uppercase tracking-[0.2em] ml-1">Secret Access Key</label>
              <div className="relative group">
                <Lock
                  size={18}
                  className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-300 group-focus-within:text-emerald-500 transition-colors"
